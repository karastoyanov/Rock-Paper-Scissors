...
class App:
    ...
    exit_btn = PhotoImage(file = r"images\exit.png")
    ...
    top_label = PhotoImage(file = r"images\videogame.png")
    top_img_label = Label(image = top_label)
    top_img_label.pack()
    top_img_label.place(x = 80, y = 60, width = 500, height = 80)
    
    
    rock_btn = PhotoImage(file = r"images\stone.png")
    ...
    paper_btn = PhotoImage(file = r"images\toilet-paper.png")
    ...
    scissors_btn = PhotoImage(file = r"images\scissors.png")
